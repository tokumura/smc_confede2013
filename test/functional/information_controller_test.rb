...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { infobody: @information.infobody, informant: @information.informant, title: @information.title }
    end
  ...
  test "should update information" do
    put :update, id: @information, information: { infobody: @information.infobody, informant: @information.informant, title: @information.title }
    assert_redirected_to information_path(assigns(:information))
  end
